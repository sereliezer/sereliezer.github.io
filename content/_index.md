...
[Publications](/publications/)  · [Contact](/about/#contact)
...
- **Anomaly detection in time-series via inductive biases in the latent space of conditional normalizing flows** (UAI 2026). Anomaly detection using conditional normalizing flows, based on failing a statistical goodness-of-fit test against prescribed latent dynamics. [Paper](https://arxiv.org/abs/2603.11756)
